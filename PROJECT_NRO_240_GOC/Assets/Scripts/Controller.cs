...
public class Controller : IMessageHandler
{
                ...
                case -98:
                    {
                        ...
                        if (num19 == 0)
                        {
                            string confirmInfo = msg.reader().readUTF();
                            string confirmData = msg.reader().readUTF();
                            GameCanvas.startYesNoDlg(confirmInfo, new Command(mResources.YES, GameCanvas.instance, 888397, confirmData), new Command(mResources.NO, GameCanvas.instance, 888396, null));
                        }
                        break;
                    }
                case -97:
                            ...
                            for (int num141 = 0; num141 < b44; num141++)
                            {
                                ...
                                if (num142 != 0)
                                {
                                    ...
                                    for (int num143 = 0; num143 < item3.itemOption.Length; num143++)
                                    {
                                        ...
                                        int param5 = msg.reader().readShort();
                                        if (num144 != -1)
                                        {
                ...
                case -77:
                    {
                        ...
                        int newSize = System.Math.Max((int)num260, 30000);
                        SmallImage.newSmallVersion = new sbyte[newSize];
                        SmallImage.maxSmall = (short)newSize;
                        SmallImage.imgNew = new Small[newSize];
                        for (int num261 = 0; num261 < newSize; num261++)
                        {
                            if (num261 < num260)
                            {
                            ...
                            {
                                SmallImage.newSmallVersion[num261] = 0;
                            }
                        }
                        break;
                    }
                ...
                case -107:
                    {
                        ...
                        for (int num148 = 0; num148 < num147; num148++)
                        {
                            ...
                            if (num151 != 0)
                            {
                                ...
                                for (int num152 = 0; num152 < Char.myPetz().arrItemBody[num148].itemOption.Length; num152++)
                                {
                                    ...
                                    int param6 = msg.reader().readShort();
                                    if (num153 != -1)
                                    {
						...
						if (GameCanvas.panel != null && GameCanvas.panel.isShow && GameCanvas.panel.type == 21)
						{
                        ...
                        for (int i = 0; i < arrBodySz; i++)
                        {
                            ...
                            if (num44 != 0)
                            {
                                ...
                                for (int j = 0; j < Char.MyPet2z().arrItemBody[i].itemOption.Length; j++)
                                {
                                    ...
                                    int param3 = msg.reader().readShort();
                                    if (num46 != -1)
                                    {
                        ...
                        for (int num266 = 0; num266 < num265; num266++)
                        {
                            ...
                            if (num269 != 0)
                            {
                                ...
                                for (int num270 = 0; num270 < Char.myCharz().arrItemBody[num266].itemOption.Length; num270++)
                                {
                                    ...
                                    int param10 = msg.reader().readShort();
                                    if (num271 != -1)
                                    {
                            ...
                            for (int num238 = 0; num238 < num237; num238++)
                            {
                                ...
                                if (num240 != 0)
                                {
                                    ...
                                    for (int num241 = 0; num241 < Char.myCharz().arrItemBag[num238].itemOption.Length; num241++)
                                    {
                                        ...
                                        int param9 = msg.reader().readShort();
                                        if (num242 != -1)
                                        {
                            ...
                            for (int num222 = 0; num222 < num221; num222++)
                            {
                                ...
                                if (num224 != 0)
                                {
                                    ...
                                    for (int num225 = 0; num225 < Char.myCharz().arrItemBox[num222].itemOption.Length; num225++)
                                    {
                                        ...
                                        int param8 = msg.reader().readShort();
                                        if (num226 != -1)
                                        {
                            ...
                            for (int num167 = 0; num167 < itemSz; num167++)
                            {
                                ...
                                if (optSz != 0)
                                {
                                    ...
                                    for (int num168 = 0; num168 < Char.myCharz().arrItemShop[num166][num167].itemOption.Length; num168++)
                                    {
                                        ...
                                        int param7 = msg.reader().readShort();
                                        if (optId != -1)
                                        {
                ...
                case -67:
                    {
                        ...
                        if (SmallImage.imgNew == null || iconId < 0 || iconId >= SmallImage.imgNew.Length)
                        {
                            break;
                        }
                        string key = "";
                        ...
                        try
                        {
                            ...
                            {
                                SmallImage.imgNew[iconId] = new Small(SmallImage.imgEmpty, iconId);
                            }
                            SmallImage.imgNew[iconId].img = img;
                            if (mGraphics.zoomLevel > 1)
                            {
                                if (SmallImage.imageRaw.ContainsKey(iconId))
                                {
    ...
    public void loadCurrMap(sbyte teleport3)
    {
        ...
        GameScr.gI().loadGameScr();
        if (TileMap.planetID != TileMap.lastPlanetId)
        {
            TileMap.lastPlanetId = TileMap.planetID;
            TileMap.lastBgID = -1;
            TileMap.lastTileID = -1;
        }
        if (TileMap.lastBgID != TileMap.bgID)
        {
            TileMap.lastBgID = -1;
        }
    ...
    public void messageNotLogin(Message msg)
    {
        try
        {
            ...
            string linkDefault = ServerListScreen.DefaultServerList;
            msg.reader().readUTF();
                            ...
                            for (int k = 0; k < Char.myCharz().arrItemBody.Length; k++)
                            {
                                ...
                                if (num9 != 0)
                                {
                                    ...
                                    for (int l = 0; l < Char.myCharz().arrItemBody[k].itemOption.Length; l++)
                                    {
                                        ...
                                        int param = msg.reader().readShort();
                                        if (num10 != -1)
                                        {
                        ...
                        for (int m = 0; m < Char.myCharz().arrItemBag.Length; m++)
                        {
                            ...
                            if (b8 != 0)
                            {
                                ...
                                for (int n = 0; n < Char.myCharz().arrItemBag[m].itemOption.Length; n++)
                                {
                                    ...
                                    int param2 = msg.reader().readShort();
                                    if (num12 != -1)
                                    {
                ...
                for (int j = 0; j < Char.myCharz().vSkill.size(); j++)
                {
                    ...
                    if (skill2.skillId == num)
                    {
                        for (int k = 0; k < 20; k++)
                        {
                            ...
                            ImgByName.getImagePath(nameImg, ImgByName.hashImagePath);
                        }
                        break;
                    }
                }
    ...
    public static void saveItemTemplatesAll()
    {
        try
        {
            myWriter dos = new myWriter();
            int size = ItemTemplates.itemTemplates.size();
            dos.writeShort((short)size);
            foreach (object obj in ItemTemplates.itemTemplates.h.Values)
            {
                ItemTemplate it = (ItemTemplate)obj;
                dos.writeShort(it.id);
                dos.writeByte((sbyte)it.type);
                dos.writeByte((sbyte)it.gender);
                dos.writeUTF(it.name);
                dos.writeUTF(it.description);
                dos.writeByte((sbyte)it.level);
                dos.writeInt(it.strRequire);
                dos.writeShort(it.iconID);
                dos.writeShort(it.part);
                dos.writeBoolean(it.isUpToUp);
            }
            Rms.saveRMSDirect("NRitem_all", dos.getData());
            dos.Close();
        }
        catch (Exception ex)
        {
            Debug.LogError("Error saving item templates all: " + ex.Message);
        }
    }

    public static void loadItemTemplatesAll()
    {
        try
        {
            sbyte[] data = Rms.loadRMSDirect("NRitem_all");
            if (data == null)
            {
                throw new Exception("NRitem_all is null");
            }
            myReader dis = new myReader(data);
            ItemTemplates.itemTemplates.clear();
            int num = dis.readShort();
            for (int i = 0; i < num; i++)
            {
                short id = dis.readShort();
                ItemTemplate it = new ItemTemplate(id, dis.readSByte(), dis.readSByte(), dis.readUTF(), dis.readUTF(), dis.readSByte(), dis.readInt(), dis.readShort(), dis.readShort(), dis.readBoolean());
                ItemTemplates.add(it);
            }
            dis.close();
        }
        ...
        {
            if (ex.Message != "NRitem_all is null")
            {
                Debug.LogError("Error loading item templates all: " + ex.Message);
            }
            else
            {
                Debug.LogWarning("NRitem_all cache not found. Fallback to server update.");
            }
            throw ex;
        }
    }
