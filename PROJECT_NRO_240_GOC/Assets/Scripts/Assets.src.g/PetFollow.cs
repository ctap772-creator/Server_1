namespace Assets.src.g
{
	public class PetFollow
	{
		...
		public void paint(mGraphics g)
		{
			...
			{
				global::Assets.src.e.Small small = SmallImage.imgNew[smallID];
				if (small != null && small.img != null)
				{
					w = mGraphics.getImageWidth(small.img);
					h = mGraphics.getImageHeight(small.img);
				}
			}
